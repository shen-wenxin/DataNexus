...
public interface MapperUtils {
    ...
    @Mapping(source = "is_verified_customer", target = "verifiedCustomer")
    @Mapping(source = "is_szse_member", target = "szseMember")
    ...
    @Mapping(source = "verifiedCustomer", target = "is_verified_customer")
    @Mapping(source = "szseMember", target = "is_szse_member")
